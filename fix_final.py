...
def inject_tts_all(texts):
    ...
    for t in texts:
        ...
        t_str = t_str.replace('</span><span style="color: #0070C0;"><strong>', '')
        t_str = t_str.replace('</span><span style="color: #00B050;"><strong>', '')
        t_str = t_str.replace('</span><span style="color: #7030A0;"><strong>', '')
...
<div style="display: flex; flex-direction: row; gap: 32px; justify-content: center; width: 100%; align-items: flex-start;">
  ...
  <div style="flex: 1; text-align: center; display: flex; flex-direction: column; align-items: center;">
    ...
    # 1-image slides (Including fixed Slide 9, 11, 17)
